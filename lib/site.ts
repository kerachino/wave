...
export const site = {
  ...
  operator: {
    tradeName: "ハトノコネクト",
    // 代表者氏名
    representative: "吉田 捷馬",
    // 事業所
    office: "東京都渋谷区本町６丁目３９番９号",
    // 詳細住所
    officeDetail: "東京都渋谷区本町６丁目３９番９号",
    // 対応エリア
    area: "全国対応（オンラインでの打ち合わせ）",
    // 連絡先メール
    email: "hatonoconnect@outlook.com",
    // 事業開始時期（※ 実績に合わせて更新）
    established: "2026年",
...
export const faqs = [
  ...
  {
    q: "支払い方法は？",
    a: "銀行振込でのお支払いです（カード決済は準備中）。原則として制作開始前の全額前払いをお願いしています。着手金＋残金の分割払いなどの個別条件は、事前に合意した場合のみ適用します。",
  },
  {
    q: "自社アプリの開発もお願いできますか？",
